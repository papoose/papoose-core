...
class FragmentImpl extends AbstractBundle
{
    ...
    public FragmentImpl(Papoose framework, long bundleId, List<NativeCodeDescription> bundleNativeCodeList, boolean bundleNativeCodeListOptional, FragmentDescription bundleFragmentHost) throws BundleException
    {
