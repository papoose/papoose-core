...
public class BundleImpl extends AbstractBundle implements Comparable<BundleImpl>
{
    ...
    void setUninstalledState() { state = UNINSTALLED_STATE; }

    void setInstalledState() { state = INSTALLED_STATE; }

    void setResolvedState() { state = RESOLVED_STATE; }

    void setStartingState() { state = STARTING_STATE; }

    void setStopingState() { state = STOPPING_STATE; }
